...
import com.yaromich.spring.entities.Student;
import com.yaromich.spring.services.StudentsService;
...
public class StudentsController {
    ...
    @Transactional
    public String removeStudentById(@PathVariable(value = "id") Long studentId) {
        studentsService.removeById(studentId);
        return "redirect:/students/list";
    }

    @RequestMapping(path = "/courses/{id}", method = RequestMethod.GET)
    public String getStudentCourses(Model model, @PathVariable(value = "id") Long studentId) {
